      ...
      Container(
        ...
        child: Instruction(
          ...
          actionButton: ElevatedButton(
            style: ElevatedButton.styleFrom(
              backgroundColor:
                  !accessibilityPermissions[1] ? Colors.blue : Colors.grey,
            ),
            onPressed: () async {
              await _checkappPlugin.requestDisableBatteryOptimization();
            },
            child: Text(
              "Disable",
              style: TextStyle(
        ...
        child: Instruction(
          ...
          actionButton: ElevatedButton(
            ...
            child: Text(
              "Enable",
              style: TextStyle(
                  color: blockPermissions[0] ? Colors.white70 : Colors.white),
            ),
          ),
        ),
      ),
        ...
        child: Instruction(
          ...
          actionButton: ElevatedButton(
            ...
            child: Text("Enable",
                style: TextStyle(
                    color:
                        blockPermissions[1] ? Colors.white70 : Colors.white)),
          ),
        ),
      ),
      Container(
        ...
        child: Instruction(
          ...
          actionButton: ElevatedButton(
            ...
            child: Text("Enable",
                style: TextStyle(
                    color:
                        blockPermissions[2] ? Colors.white70 : Colors.white)),
          ),
        ),
      ),
      Container(
        ...
        child: Instruction(
          ...
          actionButton: ElevatedButton(
            ...
            child: Text("Enable",
                style: TextStyle(
                    color:
                        blockPermissions[3] ? Colors.white70 : Colors.white)),
          ),
        ),
      ),
    ];
